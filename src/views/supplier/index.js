        ...
        <>
            ...
            >
                <Row justify='space-between'>
                    <Col span={6}>
                        <Form.Item label='供应商简码' name='code'>
                            <Input placeholder='请输入供应商简码' />
                        </Form.Item>
                    </Col>
                    <Col span={6}>
                        <Form.Item label='供应商名称' name='code'>
                            <Input placeholder='请输入供应商名称' />
                        </Form.Item>
                    </Col>
                    <Col span={6}>
                        <Form.Item label='供应商类型' name='code'>
                            <Select placeholder='请选择供应商' options={supplierTypeList} />
                        </Form.Item>
                    </Col>
                </Row>
                <Row justify='space-between'>
                    <Col span={6}>
                        <Form.Item label='合作形式' name='code'>
                            <Input placeholder='请输入供应商类型' />
                        </Form.Item>
                    </Col>
                    <Col span={6}>
                        <Form.Item label='合作情况' name='code'>
                            <Input placeholder='请输入供应商类型' />
                        </Form.Item>
                    </Col>
                    <Col span={6}>
